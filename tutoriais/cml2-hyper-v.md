...
> **Elaborado para o Workshop Academy Days 2026 — Unindo Redes, Automação e Inteligência Artificial**
...
3. Siga o assistente de instalação interativo preenchendo as seguintes informações:
   ...
   - **CML Setup:** O instalador irá detectar as duas unidades de CD/DVD configuradas no Passo 2. Ele validará a presença da ISO de instalação e montará a Refplat ISO automaticamente.
